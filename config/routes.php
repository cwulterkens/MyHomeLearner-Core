...
return static function (RouteBuilder $routes) {
    ...
    $routes->scope('/', function (RouteBuilder $builder) {
        ...
        $builder->connect('/stripe-cli', ['controller' => 'StripesWebhook', 'action' => 'handleWebhook']);
	...
	// Add a route for the universal search
    	$routes->connect('/search/{searchTerm}', ['controller' => 'Search', 'action' => 'index'])
        ->setPass(['searchTerm']);
