...
<div style="display: none; max-height: 0; overflow: hidden; line-height: 0; opacity: 0; color: #ffffff;">
    Thank you for registering with MyHomeLearner! Confirm your registration now.
</div>
...
<div class="email-wrapper">
    ...
    <div class="content">
        ...
        <p>
            <a href="https://www.myhomelearner.com/users/verification/<?= $token ?>" class="button">
    ...
    <div class="footer">
        ...
        <p>If you did not register, <a href="https://www.myhomelearner.com/contact">contact us</a>.</p>
    </div>
</div>
</body>
</html>
