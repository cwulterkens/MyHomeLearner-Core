                    ...
                    <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                ...
                                <div class="col-12 mt-0 align-content-center">
                                    <p class="small mb-0"><a href="/users/forgotpassword">Forgot Password?</a></p>
                                </div>
                                <!--
                                    <div class="col-12">
                                ...
                                <div class="text-center">
                                    <?= $this->Form->button(__('Sign In'), ['class' => 'w-100 btn btn-outline-primary']) ?>
                                </div>
                                <?= $this->Form->end() ?>
                                    <div class="col-12 mt-3 align-content-center">
                                        <p class="small mb-0">Don't have account? <a href="/users/register">Create an account</a></p>
                                    </div>
