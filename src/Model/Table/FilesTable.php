...
class FilesTable extends Table
{
     ...
     */
    public function findWithRelatedData(Query $query, array $options)
    {
        return $query
            ->contain(['FileTypes', 'Learners'])
            ->where(['user_id' => $options['user_id']]);
    }
    public function buildRules(RulesChecker $rules): RulesChecker
    {
        $rules->add($rules->existsIn('file_type_id', 'FileTypes'), ['errorField' => 'file_type_id']);
